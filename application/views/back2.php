...
<head>
  ...
  <link rel="icon" type="image/png" href="./assets/img/GL-img/gl-logo1.webp">
  <title>
    GL CRM
  </title>
  <!--     Fonts and icons     -->
  ...
  <link id="pagestyle" href="./assets/css/test.css" rel="stylesheet" />
  <link id="pagestyle" href="./assets/css/glstyle.css" rel="stylesheet" />
...
<body class="g-sidenav-show   bg-gray-100">
          ...
          <form class=" ">
            ...
            <div class="card  p-3 border-radius-xl bg-white" data-animation="FadeIn">
              ...
              <div class="row button-row d-flex mt-n1 mb-3">
                ...
                <h5 class="col-2 font-weight-bolder text-center pt-3 mb-0">Customer name</h5>
                <h5 class="col-2 font-weight-bolder text-center pt-3 mb-0">Phone Number</h5>
                <h5 class="col-2 font-weight-bolder text-center pt-3 mb-0">Email</h5>
                    ...
                    <div class="card-body p-0">
                      <div class="row   mt-3">
                        <div class="col-lg-3 col-md-2 col-3 ms-auto px-1 d-flex justify-content-center">
                          ...
                          <label class="btn  btn-outline-secondary  " for="btncheck11">
                            <h5 class="m-0">Product 1</h5>
                          </label>
                        </div>
                        <div class="col-lg-3 col-md-2 col-3 px-1 d-flex justify-content-center">
                          <input type="checkbox" class="btn-check" id="btncheck22">
                          <label class="btn  btn-outline-secondary  " for="btncheck22">
                            <h5 class="m-0">Product 2</h5>
                          </label>
                        </div>
                        <div class="col-lg-3 col-md-2 col-3 px-1 d-flex justify-content-center">
                          <input type="checkbox" class="btn-check" id="btncheck33">
                          <label class="btn  btn-outline-secondary  " for="btncheck33">
                            <h5 class="m-0">Product 3</h5>
                          </label>
                        </div>
                        <div class="col-lg-3 col-md-2 col-3 px-1 d-flex justify-content-center">
                          <input type="checkbox" class="btn-check" id="btncheck44">
                          <label class="btn  btn-outline-secondary  " for="btncheck44">
                            <h5 class="m-0">Product 4</h5>
                          </label>
                        </div>
                        <div class="col-lg-3 col-md-2 col-3 px-1 d-flex justify-content-center">
                          <input type="checkbox" class="btn-check" id="btncheck55">
                          <label class="btn  btn-outline-secondary  " for="btncheck55">
                            <h5 class="m-0">Product 5</h5>
                          </label>
                        </div>
                        <div class="col-lg-3 col-md-2 col-3 px-1 d-flex justify-content-center">
                          <input type="checkbox" class="btn-check" id="btncheck66">
                          <label class="btn  btn-outline-secondary  " for="btncheck66">
                            <h5 class="m-0">Product 6</h5>
                          </label>
                        </div>
                        <div class="col-lg-3 col-md-2 col-3 px-1 d-flex justify-content-center">
                          <input type="checkbox" class="btn-check" id="btncheck77">
                          <label class="btn  btn-outline-secondary  " for="btncheck77">
                            <h5 class="m-0">Product 7</h5>
                          </label>
                        </div>
                        <div class="col-lg-3 col-md-2 col-3 me-auto px-1 d-flex justify-content-center">
                          <input type="checkbox" class="btn-check" id="btncheck88">
                          <label class="btn  btn-outline-secondary  " for="btncheck88">
                            <h5 class="m-0">Product 8</h5>
                          </label>
                        </div>
                                  ...
                                  <div class=" ms-4">
                                    <div class="form-check d-flex justify-content-start mb-2">
                                      ...
                                      <label class="custom-control-label ms-3 my-auto" style=""
                                        for="flexCheckDefault1">Adhar</label>
                                    </div>
                                    <div class="form-check d-flex justify-content-start mb-2">
                                      <input class="form-check-input " type="checkbox" value="" id="flexCheckDefault2">
                                      <label class="custom-control-label ms-3 my-auto" style=""
                                        for="flexCheckDefault2">pan</label>
                                    </div>
                                    <div class="form-check d-flex justify-content-start mb-2">
                                      <input class="form-check-input " type="checkbox" value="" id="flexCheckDefault3">
                                      <label class="custom-control-label ms-3 my-auto" style=""
                                        for="flexCheckDefault3">amc</label>
                                    </div>
                                    <div class="form-check d-flex justify-content-start mb-2">
                          ...
                          <table class="table align-items-center   mb-0">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="align-baseline text-center text-sm">
                                  <div class="d-flex mb-2 flex-row justify-content-center">
                                    <select class="select-box form-control" name="">
                                  ...
                                  <div class="d-flex mb-2 flex-row justify-content-center">
                                    <select class="select-box form-control" name="choices-button-discount" placeholder="">
                                      <option value="" selected="">dept name</option>
                                      <option value="Choice 1">1</option>
                                      <option value="Choice 2">2</option>
                                      <option value="Choice 3">3</option>
  ...
  <script src="./assets/js/plugins/choices.js"></script>
