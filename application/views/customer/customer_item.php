    ...
    <div class="container-fluid mt-n4 py-4">
      ...
      <div class="row mt-n2">
        <div class="col-12 col-lg-12 m-auto">
          <form method="POST" id="cust_item_submit" >
            ...
            <div class="card  p-3 border-radius-xl bg-white" data-animation="FadeIn">
              ...
              <div class="row button-row d-flex mt-n1 mb-3">
                ...
                <button class="col-4 btn bg-gradient-success ms-auto mb-0 js-btn-next p-3" type="submit"
                        ...
                        <div class=" ms-1 pe-md-3 row justify-content-center mb-3">
                          <div class="col-12">
                            ...
                            <select class="form-control select2" name="country">
                              ...
                              <!-- <input type="text" id="exampleDataList" list="datalistOptions" class="form-control" placeholder="Type here...">
                              <span class="bg-gradient-success input-group-text text-body"><i
                                  class="fas fa-search text-white" aria-hidden="true"></i></span>
                                    ...
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder  ps-2">
                                            <button type="button" class="mb-2 w-100 btn bg-gradient-danger text-sm class_rmv_itm" id="<?= $row1->item_id ?>" >Remove </button>
                                        </th>
