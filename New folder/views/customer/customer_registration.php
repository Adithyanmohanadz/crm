                              ...
                              <div class="col-12 col-sm-4">
                                ...
                                <div class="row px-xl-5 px-sm-4 px-0  mt-1">
                                  ...
                                  <div class="col-3 me-auto px-1">
                                    <a class="btn btn-outline-light mb-0 w-100" href="javascript:;">
                                      <img width="32px" height="22px" src="<?= base_url() ?>assets/img/GL-img/flag/canada.jpg" alt=""
                                        value="+1">
                                    </a>
                                  </div>
                                </div>
                                  ...
                                  <div class="col">
                                    <div class="form-check ">
                                      ...
                                      <label class="custom-control-label " style=""
                                        for="flexCheckDefault1"><?= $row->website_name ?></label>
                                    </div>
                                  </div>
                                </div>  
                              <?php } ?>                                                        
                              ...
                              <div class="card-body">
                                <div class="row mt-3">
                                  <div class="col-12 col-sm-12">
                                    ...
                                    <select class="select-box form-control" name="agent" id="choices-button-agent" >                                      
