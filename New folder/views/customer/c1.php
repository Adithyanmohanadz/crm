                  ...
                  <div class="card  p-3 border-radius-xl bg-white" data-animation="FadeIn">
                    ...
                    <div class="">
                      ...
                      <div class="row button-row d-flex mt-n1 mb-3">
                        ...
                        <a href="p-4.html" class="col-4 btn bg-gradient-success ms-auto mb-0 js-btn-next p-3"
                          type="button" title="Submit">Submit</a>
                      </div>
                                        ...
                                        <tr>
                                          ...
                                          <td class="align-baseline text-center text-sm">
                                            <div class="d-flex mb-2 flex-row justify-content-center">
                                              <select class="select-box form-control" name="choices-button-discount"
                                                id="which_user" placeholder="Departure">
                                            ...
                                            <div class="d-flex mb-2 flex-row justify-content-center">
                                              <select class="select-box form-control" name="choices-button-discount"
                                                id="dept_name" placeholder="Departure">
                                            ...
                                            <div class="d-flex mb-2 flex-row justify-content-center">
                                              <select class="select-box form-control" name="choices-button-discount"
                                                id="dpt_person" placeholder="Departure">
                                          ...
                                          <td class="align-items-center text-center text-sm">
                                            ...
                                            <div class="d-flex  flex-column justify-content-center">
                                              <!-- Button trigger modal -->
                                              <button type="button" class="btn btn-outline-secondary btn-block mb-3" data-bs-toggle="modal" data-bs-target="#exampleModalMessage">
                                                Message 
                                              </button>
                                        ...
                                        <tr>
                                          <thead>
                                            <tr>
                                              ...
                                              <th
                                                class="col-2 text-uppercase text-secondary text-xxs font-weight-bolder ps-2">
                                                <select class="form-control select-box" name=""
                                                  id="" placeholder="Departure">
                                      ...
                                      <table class="table align-items-center   mb-0">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td class="align-baseline text-center text-sm">
                                              <div class="d-flex mb-2 flex-row justify-content-center">
                                                <select id="which_user2"  class="select-box form-control" name="">
